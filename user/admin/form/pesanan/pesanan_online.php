...
<div class="box-body">
	...
	$q = mysqli_query($conn, "
		...
		where c.status='Order' or d.status='Order'
	...
	$no = 1;
		...
		<tr>
			...
			<td>
				<a href="?a=detail_pesanan&idp=<?php echo $d['id_pelanggan'] ?>&waktu=<?php echo $d['waktu_create'] ?>&via=<?php echo $d['order_via'] ?>&id_tagihan=<?php echo $d['id_tagihan'] ?>&menu=pesan_online" class="btn btn-info btn-xs">Detail</a>
			</td>
		</tr>
	<?php }
	 ?>
