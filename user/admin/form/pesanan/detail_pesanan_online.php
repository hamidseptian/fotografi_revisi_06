...
$sisa_tagihan = $totalbiaya	-$d_tagihan['dibayar'];
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
			 	...
			 	<div class="form-group">
			 		...
			 		<input type="text" name="ket" class="form-control" value="Lunas">
			 	</div>
...
<?php } ?>
	...
	if ($total_bayar>0): ?>
		<br>
		<a href="form/pesanan/print_tanda_terima.php?waktu=<?php echo $waktu ?>&id_tagihan=<?php echo $id_tagihan ?>&id_pelanggan=<?php echo $id ?>" target="_blank" class="btn btn-info btn-xs">Print Tanda Terima</a>
	<?php endif ?>
</div>
<?php } ?>