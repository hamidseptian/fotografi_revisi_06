...
if ($tb==$jp) { 
	...
	<script type="text/javascript">
		...
		window.location.href='../../?a=detail_booking_selesai&idp=<?php echo $iduser ?>&waktu=<?php echo $waktu ?>&status=Selesai'
	</script>
<?php }
else{ ?>
	<script type="text/javascript">
		alert('Gagal menyimpan\nmasukan jumlah pembayaran sebanyak jumlah sisa');
		window.location.href='../../?a=detail_booking_selesai&idp=<?php echo $iduser ?>&waktu=<?php echo $waktu ?>'
	</script>
<?php }
?>