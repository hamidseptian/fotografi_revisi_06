<div class="box-header">
	<h3 class="box-title">Pesanan Online</h3>
...
<div class="box-body">
	...
	$no = 1;
		...
		SELECT * from cetak_foto as a 
		where a.id_pelanggan='$idp' and waktu_pesan='$waktu'		
		");
		...
		<tr>
			...
			<td>
				<?php if ($jp==0) { ?>
				<a href="?a=detail_order&idp=<?php echo $d['id_pelanggan'] ?>&waktu=<?php echo $d['waktu_pesan'] ?>&status=<?php echo $d['status'] ?>" class="btn btn-info btn-xs">Detail</a>
