...
$q = mysqli_query($conn, "SELECT * from booking b left join paket p on b.id_paket= p.id_paket where b.tanggal_mulai >= '$tglawal' and b. tanggal_selesai <= '$akhir' and b.status='Dalam Proses'");
...
<?php 	}else{ ?>
<a href="?m=addbooking&tgl=<?php echo $tglbook ?>&idj=<?php echo $id ?>&jenis=<?php echo $jenis_potret ?>&lokasi=<?php echo $lokasi ?>&lama=<?php echo $lama ?>&jambook=<?php echo $jambook ?>&tgl_selesai=<?php echo  $sesudah ?>" class="btn btn-info btn-xs">Booking</a>
